			...
			<div class="container px-0">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav m-auto m-sm-0">
						...
						<li class="nav-item">
							<div class="dropdown show nav-link dropdown_user_books">
								<a class="dropdown-toggle" href="#" role="button" id="dropdown_user_books"
									data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									Last Hour
								</a>
								<div class="dropdown-menu mb-2" aria-labelledby="dropdown_user_books">
						...
						<form class="form-inline my-2 my-lg-0 search_box-wrapper">
							<div class="input-group mb-0">
								...
								<input id="myInput" class="form-control mr-0 search_box" type="search"
									placeholder="Search here ..." aria-label="Search" onkeyup="myFunction()">
							</div>
						</form>

						<div class="profile_menu">
							<a class="profile" href="{{ url('myaccount') }}" >
				...
				<div class="row">
					...
					<div id="book__body" class="col-lg-9 col-md-8 col-sm-12 book_body">
						...
						<div id="chapter_1-id" class="chapter">
							...
							<div id="topic_1-1-id" class="topic">
								<!-- Topic title -->
                            @foreach($topics as $topic)
								<h3 class="text-center text-uppercase text-primary border-bottom border-top my-4 py-0">{{ $topic->subject->subject_name }}
								</h3>
								<h4 class="text-center text-uppercase border-bottom my-2 py-0">{{ $topic->chapters->chapter_name }}</h4>
								<h5 class="text-uppercase border-bottom my-2 py-0 d-inline-block">{{ isset($topic->topic_name)? $topic->topic_name:'' }}</h5>
								...
								<div class="Q card">
                                    ...
                                    @foreach($topic->questions as $question)
													...
													@foreach($question->question_answers as $answer)
														<tr>
															<td width="30" class="p-0 text-center">
																<input class="tf_ans_input" type="radio" name="a-q-id"
																	id="t-a-q-id">
										...
										<!--Ans Button Start-->
										<button type="button" onclick="testAns()" class="btn btn-primary"
											data-toggle="modal" data-target="#ans-Q-id">Ans.</button>
										<!--Ans Button End-->


										<!--Explanation Modal Start-->
										<button type="button" class="btn btn-primary" data-toggle="modal"
											data-target="#explanation-Q-id">Explanation</button>

										<div class="modal fade bd-example-modal-lg" id="explanation-Q-id" tabindex="-1"
										...
										<button type="button" class="btn btn-primary" data-toggle="modal"
											data-target="#reference-Q-id">Reference</button>

										<div class="modal fade bd-example-modal-sm" id="reference-Q-id" tabindex="-1"
											role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div class="card card-body">
															<ul>
																<li><a class="btn-link"
																		href="#">Janqueira's/15th/P-38</a></li>
										...
										<!--Comment Modal Start-->
										<button type="button" class="btn btn-primary" data-toggle="modal"
											data-target="#comment-Q-id">Comment</button>


										<div class="modal fade" id="comment-Q-id" tabindex="-1" role="dialog"
													...
													<div class="modal-body">
														<form>
															<div class="form-group">
																...
																<button type="button"
																	class="btn btn-primary float-right mt-1">Submit</button>
															</div>
														</form>
													</div>
													<div class="modal-footer">
										...
										<!--Exam Modal Start-->
										<button type="button" class="btn btn-primary" data-toggle="modal"
											data-target="#exam-Q-id">Quick
											Exam</button>

										<div class="modal fade bd-example-modal-lg" id="exam-Q-id" tabindex="-1"
											role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
											<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
												<div class="modal-content">
													<div class="modal-header">
															...
															<form>
																<div class="table-responsive">
																	<table class="table table-borderless">
																		<tr>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="a-e-q-id" id="t-a-e-q-id">
																				<label class="tf_ans"
																					for="t-a-e-q-id">T</label>
																			</td>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="a-e-q-id" id="f-a-e-q-id">
																				<label class="tf_ans"
																					for="f-a-e-q-id">F</label>
																			</td>
																			<td class="p-0 pl-md-2">
																		...
																		<tr>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="b-e-q-id" id="t-b-e-q-id">
																				<label class="tf_ans"
																					for="t-b-e-q-id">T</label>
																			</td>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="b-e-q-id" id="f-b-e-q-id">
																				<label class="tf_ans"
																					for="f-b-e-q-id">F</label>
																			</td>
																			<td class="p-0 pl-md-2">
																		...
																		<tr>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="c-e-q-id" id="t-c-e-q-id">
																				<label class="tf_ans"
																					for="t-c-e-q-id">T</label>
																			</td>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="c-e-q-id" id="f-c-e-q-id">
																				<label class="tf_ans"
																					for="f-c-e-q-id">F</label>
																			</td>
																			<td class="p-0 pl-md-2">
																		...
																		<tr>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="d-e-q-id" id="t-d-e-q-id">
																				<label class="tf_ans"
																					for="t-d-e-q-id">T</label>
																			</td>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="d-e-q-id" id="f-d-e-q-id">
																				<label class="tf_ans"
																					for="f-d-e-q-id">F</label>
																			</td>
																			<td class="p-0 pl-md-2">
																		...
																		<tr>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="e-e-q-id" id="t-e-e-q-id">
																				<label class="tf_ans"
																					for="t-e-e-q-id">T</label>
																			</td>
																			<td width="30" class="p-0 text-center">
																				<input class="tf_ans_input" type="radio"
																					name="e-e-q-id" id="f-e-e-q-id">
																				<label class="tf_ans"
																					for="f-e-e-q-id">F</label>
																			</td>
																			<td class="p-0 pl-md-2">
										...
										<!-- Video Lecture start-->
										<button type="button" class="btn btn-primary venobox" data-autoplay="true"
											data-vbtype="video"
											href="https://www.youtube.com/embed/IbZcKSG6T4c">Video</button>
										<!--Video Lecture end-->
