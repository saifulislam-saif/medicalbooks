        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                        {!! Form::open(['action'=>['Admin\LsTopicController@update',$lecture_topic->id],'method'=>'PUT','files'=>true,'class'=>'form-horizontal']) !!}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('ls_chapter_id',$lecture_chapter, $lecture_topic->ls_chapter_id,['class'=>'form-control','required'=>'required']) !!}<i></i>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon right">
                                        <input type="text" name="topic_name" required value="{{ $lecture_topic->topic_name }}" class="form-control">
                                    </div>
                                </div>
                            </div>
