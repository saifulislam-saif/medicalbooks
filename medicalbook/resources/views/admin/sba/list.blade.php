                    ...
                    <table class="table table-striped table-bordered table-hover datatable">
                        ...
                        @foreach($questions as $question)
                            <tr>
                                ...
                                <td>{{ $question->book->book_name }}</td>
                                <td>
                                    <a href="{{ url('admin/sba/'.$question->id.'/edit') }}" class="btn btn-xs btn-primary">Edit</a>
                                    {!! Form::open(array('route' => array('sba.destroy', $question->id), 'method' => 'delete','style' => 'display:inline')) !!}
