        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['action'=>['Admin\BooksController@store'],'files'=>true,'class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <input type="text" name="book_name" required value="{{ old('book_name') }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <input type="number" name="coupon_price" required value="{{ old('coupon_price') }}" class="form-control">
                                </div>
                            </div>
                        </div>
