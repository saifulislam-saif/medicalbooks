...
<head>
    <meta charset="utf-8"/>
    <title>Tempore | Admin Login</title>
...
<div class="content">
    ...
    <form class="login-form" action="{{ url('admin/login') }}" method="post">
        {{ csrf_field() }}
        <h3 class="form-title">Enter Confirmation Code</h3>
        ...
        <div class="form-group">
            ...
            <label class="control-label visible-ie8 visible-ie9">Confirmation Code</label>
            <div class="input-group">
                <input type="hidden" name="email" value="{{ session('email') }}">
                <input type="hidden" name="password" value="{{ session('password') }}">
                <span class="input-group-addon"></span>
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Confirmation Code" name="confirmation_code"/>
            </div>
        </div>
